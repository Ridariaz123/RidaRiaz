...
public class CompetitionGUI extends JFrame {
    ...
    public void updateCompetitorTable() {
        ...
        String filePath = localDir + "\\src\\competitors.csv";
        if ("staff".equals(currentUser.getRole())) {
...
private boolean isInteger(String str) {
    ...
    private void generateFinalReport() {
         if ("competitor".equals(currentUser.getRole())) {
            JOptionPane.showMessageDialog(this, "Competitors are not allowed to generate final report.", "Access Denied", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        String localDir = System.getProperty("user.dir");
        String filePath = localDir + "\\src\\final_report.txt";  // Change this path
